...
ctrl_F           = lued.find_forward_selected -- Find. If text is selected the find selected text (Similar to Sublime Ctrl+F3).
...
alt_sf           = lued.sel_to_match            lued.hot("sf") -- Select to match
alt_SF           = lued.sel_to_match_reverse    lued.hot("SF") -- Select to match (reverse)
...
alt_d4           = lued.del_char_4              lued.hot("d4") -- Delete 4 char. alt+d4 deletes 4 char
alt_d5           = lued.del_char_5              lued.hot("d5") -- Delete 5 char. alt+d5 deletes 5 char
alt_d6           = lued.del_char_6              lued.hot("d6") -- Delete 6 char. alt+d6 deletes 6 char
alt_d7           = lued.del_char_7              lued.hot("d7") -- Delete 7 char. alt+d7 deletes 7 char
alt_d8           = lued.del_char_8              lued.hot("d8") -- Delete 8 char. alt+d8 deletes 8 char
alt_d9           = lued.del_char_9              lued.hot("d9") -- Delete 9 char. alt+d9 deletes 9 char
...
alt_dc           = lued.del_char                               -- Delete N char. alt+dc20 deletes 20 char
alt_DC           = lued.del_backspace                          -- Delete N char backwards alt+dc20 deletes backwards 20 char
...
alt_gg           = lued.grep_sel_all_files      lued.hot("gg")  -- Grep/Find all matches in all open files.
alt_GG           = lued.grep_goback             lued.hot("GG")  -- Return to previous file before grep.  The previous files are stacked so you can go back multiple files.
alt_grep         = lued.grep_sel_file_glob      lued.hot("grep")  -- Find all matches in specific files.
...
alt_INCR         = lued.decr                    lued.hot("INCR") -- Decrement next line's index.
...
alt_help         = lued.open_file_bindings      lued.hot("help") -- Help. Open lued_bindings.lua
...
alt_Ss           = lued.save_session_file       lued.hot("Ss")   -- Save session file
alt_Sl           = lued.load_session_file       lued.hot("Sl")   -- Load session file
