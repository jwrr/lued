...
alt_gg           = lued.grep_sel_all_files      lued.hot("gg")  -- Find all matches in all open files.
alt_GG           = lued.grep_sel_this_file      lued.hot("GG")  -- Find all matches in current file.
