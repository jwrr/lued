...
alt_pp           = move_down_n_pages       hot("pp")
alt_PP           = move_up_n_pages         hot("PP")
...
alt_ww           = move_right_n_words      hot("ww")
alt_WW           = move_left_n_words       hot("WW")
alt_wq           = move_to_sol             hot("wq")
alt_we           = move_to_eol             hot("we")
