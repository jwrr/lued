...
alt_fw           = set_find_whole_word     hot("fw")  -- toggle find whole word
alt_FW           = clr_find_whole_word     hot("FW")  -- toggle find whole word
...
alt_ln           = set_line_numbers        hot("ln")  -- show line numbers
alt_LN           = clr_line_numbers        hot("LN")  -- show line numbers
